...
const portfolioNetflixPage = () => {
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            <div className='absolute top-0 w-full h-[30vh] lg:h-[40vh] bg-black/60 z-10'/>
            <Image className='absolute z-1' layout='fill' objectFit='cover' src={portfolioNetflix} alt='Green Card & Visa'/>
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                <h2 className='py-2'>Netflix Clon</h2>
                <h3>UI-App-Firebase-Auth</h3>
            </div>
        </div>
        ...
        <div className='max-2-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                <p>Plantilla</p>
                <h2>Netflix Clon</h2>
                <p>Interfaz de usuario de Netflix en menú de inicio. Autenticación 
                    de usuario. Agregar a mi lista.
                </p>
                <Link target='_blank' href='https://netflix-react-js-f41dc.web.app/'>
...
export default portfolioNetflixPage