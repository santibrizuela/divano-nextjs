    ...
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                <h2 className='py-2'>RE-SIS-TEN.COM</h2>
        ...
        <div className='max-2-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                <p>Proyecto Activo</p>
                <h2>RE-SIS-TEN.COM</h2>
                <p>Fabricantes líderes en el mercado de RESISTENCIAS ELÉCTRICAS 
                    con más de 40 años de trayectoria. Tenemos stock resistencias de 
                    artículos DOMESTICOS como hornos, anafes, estufas, bebederos, 
                    pavas, etc. Productos como pirómetros, termocuplas o pantallas de 
                    las marcas más reconocidas en el sector industrial (Dynisco, 
                    Elstein, Taisuo, Maxwell) pueden encontrarse en nuestro local.
                </p>
                <Link target='_blank' href='https://resisten.com.ar/'>
