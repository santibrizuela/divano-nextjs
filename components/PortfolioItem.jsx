...
const PortfolioItem = ({title, backgroundImg, projectUrl, detail}) => {
  return (
    <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-t from-[#10b981] to-[#1f2937]'>
